...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
  ...
  //      mMap.setMyLocationEnabled(true);
     ...
     //   final Location myLocation = locationManager.getLastKnownLocation();
       ...
       Button btnInvia = (Button) findViewById(R.id.button);
        btnInvia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String w = new Date().toString();
                geoFire.setLocation(("posizione di prova"+ w),new GeoLocation(lat,lng));
                geoQuery= geoFire.queryAtLocation(new GeoLocation(lat,lng),600.00);
...
//        mMap.addMarker(new MarkerOptions().position(sydney).title("prova"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://samu.andre.geopc/http/host/path")
        );
